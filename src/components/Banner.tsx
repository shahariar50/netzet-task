    ...
    <div>
      <div className="md:max-w-3xl lg:max-w-5xl mx-auto">
        <div className="w-full relative z-10">
          <div className="md:absolute bottom-0 md:right-[calc(0%-90px)] -z-1">
            <Image
              src="/banner.png"
              alt="banner"
          ...
          <div className="container -mt-15 sm:-mt-4 md:mt-0">
            <div className="max-w-[516px] md:pt-14 lg:pt-18 pb-10 md:pb-12 lg:pb-20">
              <div className="flex flex-col">
                <div className="px-2 md:px-0 text-center md:text-left mb-4">
                ...
                <div className="md:mb-[30px] md:w-min order-2 md:order-1">
                ...
                <div className="text-[#ababab] order-1 md:order-2 max-w-[281px] md:max-w-full mx-auto text-center md:text-left mb-8 md:mb-0">
